...
usage(const char *pname)
{
	...
	fprintf(stderr,
	        ...
	        "   -c, --center-freq <hz>  Set the center carrier frequency to <Hz> (default: 0 Hz)\n"
	        "   -d, --freq-delta <hz>   Search for the carrier at most <hz> Hz away from the center frequency (default: 5000)\n"
